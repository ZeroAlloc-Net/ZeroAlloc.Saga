...
internal sealed class SingleStepSaga_OrderPlaced_Handler : INotificationHandler<global::Sample.OrderPlaced>
{
    ...
    public SingleStepSaga_OrderPlaced_Handler(IServiceScopeFactory scopeFactory, SagaLockManager<global::Sample.OrderId> locks, SagaRetryOptions retry, ILogger<SingleStepSaga_OrderPlaced_Handler> log)
    {
    ...
    public async ValueTask Handle(global::Sample.OrderPlaced @event, CancellationToken ct)
    {
        ...
        while (true)
        {
            ...
            var store = scope.ServiceProvider.GetRequiredService<ISagaStore<SingleStepSaga, global::Sample.OrderId>>();
