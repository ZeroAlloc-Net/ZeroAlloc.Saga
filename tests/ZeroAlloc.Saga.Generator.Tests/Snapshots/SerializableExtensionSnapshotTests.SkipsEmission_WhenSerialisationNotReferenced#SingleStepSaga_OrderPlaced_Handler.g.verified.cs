...
internal sealed class SingleStepSaga_OrderPlaced_Handler : INotificationHandler<global::Sample.OrderPlaced>
{
    ...
    public SingleStepSaga_OrderPlaced_Handler(ISagaStore<SingleStepSaga, global::Sample.OrderId> store, SagaLockManager<global::Sample.OrderId> locks, ISagaCommandDispatcher dispatcher, SagaRetryOptions retry, ILogger<SingleStepSaga_OrderPlaced_Handler> log)
    {
        _store = store;
        _locks = locks;
