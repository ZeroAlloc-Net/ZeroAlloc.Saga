...
internal sealed class ExcludedFieldSaga_Started_Handler : INotificationHandler<global::Sample.Started>
{
    ...
    public ExcludedFieldSaga_Started_Handler(ISagaStore<ExcludedFieldSaga, int> store, SagaLockManager<int> locks, ISagaCommandDispatcher dispatcher, SagaRetryOptions retry, ILogger<ExcludedFieldSaga_Started_Handler> log)
    {
        _store = store;
        _locks = locks;
