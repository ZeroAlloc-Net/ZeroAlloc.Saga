...
internal sealed class MultiFailureSaga_OrderPlaced_Handler : INotificationHandler<global::Sample.OrderPlaced>
{
    ...
    public MultiFailureSaga_OrderPlaced_Handler(ISagaStore<MultiFailureSaga, global::Sample.OrderId> store, SagaLockManager<global::Sample.OrderId> locks, ISagaCommandDispatcher dispatcher, SagaRetryOptions retry, ILogger<MultiFailureSaga_OrderPlaced_Handler> log)
    {
        _store = store;
        _locks = locks;
