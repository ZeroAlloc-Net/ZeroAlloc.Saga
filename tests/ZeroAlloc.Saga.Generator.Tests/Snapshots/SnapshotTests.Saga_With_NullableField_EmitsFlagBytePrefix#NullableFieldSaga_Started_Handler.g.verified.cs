...
internal sealed class NullableFieldSaga_Started_Handler : INotificationHandler<global::Sample.Started>
{
    ...
    public NullableFieldSaga_Started_Handler(ISagaStore<NullableFieldSaga, int> store, SagaLockManager<int> locks, ISagaCommandDispatcher dispatcher, SagaRetryOptions retry, ILogger<NullableFieldSaga_Started_Handler> log)
    {
        _store = store;
        _locks = locks;
