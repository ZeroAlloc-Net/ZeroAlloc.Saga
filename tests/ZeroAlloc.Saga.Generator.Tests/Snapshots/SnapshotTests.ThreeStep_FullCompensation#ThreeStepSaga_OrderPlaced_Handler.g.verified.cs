...
internal sealed class ThreeStepSaga_OrderPlaced_Handler : INotificationHandler<global::Sample.OrderPlaced>
{
    ...
    public ThreeStepSaga_OrderPlaced_Handler(ISagaStore<ThreeStepSaga, global::Sample.OrderId> store, SagaLockManager<global::Sample.OrderId> locks, IMediator mediator, SagaRetryOptions retry, ILogger<ThreeStepSaga_OrderPlaced_Handler> log)
    {
        _store = store;
        _locks = locks;
        _mediator = mediator;
