...
internal sealed class MultiFailureSaga_ChargedOk_Handler : INotificationHandler<global::Sample.ChargedOk>
{
    ...
    public MultiFailureSaga_ChargedOk_Handler(ISagaStore<MultiFailureSaga, global::Sample.OrderId> store, SagaLockManager<global::Sample.OrderId> locks, ISagaCommandDispatcher dispatcher, SagaRetryOptions retry, ILogger<MultiFailureSaga_ChargedOk_Handler> log)
    {
        _store = store;
        _locks = locks;
