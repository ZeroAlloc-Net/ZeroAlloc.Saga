...
internal sealed class TypedIdFieldSaga_Activated_Handler : INotificationHandler<global::Sample.Activated>
{
    ...
    public TypedIdFieldSaga_Activated_Handler(IServiceScopeFactory scopeFactory, SagaLockManager<global::Sample.CustomerId> locks, SagaRetryOptions retry, ILogger<TypedIdFieldSaga_Activated_Handler> log)
    {
    ...
    public async ValueTask Handle(global::Sample.Activated @event, CancellationToken ct)
    {
        ...
        while (true)
        {
            ...
            var store = scope.ServiceProvider.GetRequiredService<ISagaStore<TypedIdFieldSaga, global::Sample.CustomerId>>();
