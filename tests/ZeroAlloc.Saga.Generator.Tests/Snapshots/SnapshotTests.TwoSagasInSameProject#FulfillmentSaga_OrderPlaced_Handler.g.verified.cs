...
internal sealed class FulfillmentSaga_OrderPlaced_Handler : INotificationHandler<global::Sample.OrderPlaced>
{
    ...
    public FulfillmentSaga_OrderPlaced_Handler(IServiceScopeFactory scopeFactory, SagaLockManager<global::Sample.OrderId> locks, SagaRetryOptions retry, ILogger<FulfillmentSaga_OrderPlaced_Handler> log)
    {
    ...
    public async ValueTask Handle(global::Sample.OrderPlaced @event, CancellationToken ct)
    {
        ...
        while (true)
        {
            ...
            var store = scope.ServiceProvider.GetRequiredService<ISagaStore<FulfillmentSaga, global::Sample.OrderId>>();
