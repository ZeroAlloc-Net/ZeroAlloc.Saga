...
internal sealed class MultiFieldOrderSaga_Started_Handler : INotificationHandler<global::Sample.Started>
{
    ...
    public MultiFieldOrderSaga_Started_Handler(ISagaStore<MultiFieldOrderSaga, int> store, SagaLockManager<int> locks, ISagaCommandDispatcher dispatcher, SagaRetryOptions retry, ILogger<MultiFieldOrderSaga_Started_Handler> log)
    {
        _store = store;
        _locks = locks;
